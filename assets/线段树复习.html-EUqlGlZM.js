import{_ as n,o as s,c as a,e as t}from"./app-cf8tM2CS.js";const p={},e=t(`<h2 id="线段树复习" tabindex="-1"><a class="header-anchor" href="#线段树复习" aria-hidden="true">#</a> 线段树复习</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">RangeTree</span> <span class="token punctuation">{</span>
