import{_ as n,c as s,o as a,b as e}from"./app-B5uJTUF5.js";const t={},p=e(`<h1 id="frp配置过程记录-ipad远程登录电脑" tabindex="-1"><a class="header-anchor" href="#frp配置过程记录-ipad远程登录电脑"><span>frp配置过程记录(ipad远程登录电脑)</span></a></h1><h2 id="服务端配置过程" tabindex="-1"><a class="header-anchor" href="#服务端配置过程"><span>服务端配置过程</span></a></h2><p><strong>准备工作</strong></p><pre><code class="language-bash"><span class="token comment"># 从github下载frp的releases版本</span>
