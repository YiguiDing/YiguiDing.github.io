import{_ as n,o as s,c as e,e as a}from"./app-SitNf3_1.js";const i={},l=a(`<h1 id="frp配置过程记录-ipad远程登录电脑" tabindex="-1"><a class="header-anchor" href="#frp配置过程记录-ipad远程登录电脑" aria-hidden="true">#</a> frp配置过程记录(ipad远程登录电脑)</h1><h2 id="服务端配置过程" tabindex="-1"><a class="header-anchor" href="#服务端配置过程" aria-hidden="true">#</a> 服务端配置过程</h2><p><strong>准备工作</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 从github下载frp的releases版本</span>
