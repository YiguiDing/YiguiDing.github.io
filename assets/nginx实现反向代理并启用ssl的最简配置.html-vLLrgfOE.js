import{_ as n,o as e,c as s,e as i}from"./app-cM6bnKm8.js";const l={},d=i(`<h1 id="nginx实现反向代理并启用ssl的最简配置" tabindex="-1"><a class="header-anchor" href="#nginx实现反向代理并启用ssl的最简配置" aria-hidden="true">#</a> nginx实现反向代理并启用ssl的最简配置</h1><div class="language-confg line-numbers-mode" data-ext="confg"><pre class="language-confg"><code>server {
    listen       8082; 
