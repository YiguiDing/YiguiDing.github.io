...
`)])],-1),x=n("pre",null,[n("code",{class:"language-ts"},[s("源代码"),n("span",{class:"token operator"},":"),s(`
...
`),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token punctuation"},"]"),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])],-1),f=o(`<h2 id="词法分析的实现" tabindex="-1"><a class="header-anchor" href="#词法分析的实现"><span>词法分析的实现</span></a></h2><p><code>Tokenizer.ts</code></p><pre><code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">type</span> <span class="token class-name">TokenType</span> <span class="token operator">=</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">Tokenizer</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="文法定义" tabindex="-1"><a class="header-anchor" href="#文法定义"><span>文法定义</span></a></h2><p><code>ast.ts</code></p><pre><code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">{</span> TokenType <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./Tokenizer&#39;</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><h2 id="文法分析的实现" tabindex="-1"><a class="header-anchor" href="#文法分析的实现"><span>文法分析的实现</span></a></h2><p><code>Parser.ts</code></p><pre><code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">{</span> TokenType<span class="token punctuation">,</span> Token <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./Tokenizer&#39;</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">Parser</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="解释器的实现" tabindex="-1"><a class="header-anchor" href="#解释器的实现"><span>解释器的实现</span></a></h2><p><code>Interpreater.ts</code></p><pre><code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">{</span> <span class="token constant">AST_NODE</span> <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./ast&#39;</span><span class="token punctuation">;</span>
