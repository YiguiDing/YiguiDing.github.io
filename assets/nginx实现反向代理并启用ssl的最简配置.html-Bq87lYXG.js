import{_ as e,o as n,c as i,b as s}from"./app-CX2ta7kB.js";const t={},l=s(`<h1 id="nginx实现反向代理并启用ssl的最简配置" tabindex="-1"><a class="header-anchor" href="#nginx实现反向代理并启用ssl的最简配置"><span>nginx实现反向代理并启用ssl的最简配置</span></a></h1><div class="language-confg line-numbers-mode" data-ext="confg" data-title="confg"><pre class="language-confg"><code>server {
    listen       8082; 
