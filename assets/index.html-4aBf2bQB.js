import{_ as a,r as t,o as c,c as i,a as n,b as s,f as l,e as o}from"./app-o00Oe8Fi.js";const p={},d=n("h2",{id:"ubuntu23-10相关配置过程记录",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#ubuntu23-10相关配置过程记录","aria-hidden":"true"},"#"),s(" Ubuntu23.10相关配置过程记录")],-1),r=n("h3",{id:"通过netplan配置网络",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#通过netplan配置网络","aria-hidden":"true"},"#"),s(" 通过Netplan配置网络")],-1),u={href:"https://netplan.io",target:"_blank",rel:"noopener noreferrer"},m=o(`<blockquote><p>Ubuntu 20.4 没有/etc/network/interfaces，配置网络需用Netplan</p></blockquote><blockquote><p>Netplan 是一个用于在 linux 系统上轻松配置网络的实用程序。您只需创建所需网络接口的 YAML 描述以及每个应配置的功能。根据此描述，Netplan 将为您选择的渲染器工具生成所有必要的配置。</p></blockquote><p><strong>配置网络</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建配置文件</span>
