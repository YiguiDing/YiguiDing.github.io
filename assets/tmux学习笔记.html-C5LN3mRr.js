import{_ as n,c as e,o as t,b as a}from"./app-BSX0n7Vp.js";const s={},o=a(`<h1 id="tmux学习笔记" tabindex="-1"><a class="header-anchor" href="#tmux学习笔记"><span>tmux学习笔记</span></a></h1><h2 id="安装tmux" tabindex="-1"><a class="header-anchor" href="#安装tmux"><span>安装tmux</span></a></h2><pre><code class="language-bash"><span class="token function">apt-get</span> update
<span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> tmux
</code></pre><h2 id="创建、列出、连接、删除会话" tabindex="-1"><a class="header-anchor" href="#创建、列出、连接、删除会话"><span>创建、列出、连接、删除会话</span></a></h2><pre><code class="language-bash"><span class="token comment"># 创建 tmux会话session</span>
...
</code></pre><h2 id="关于会话session" tabindex="-1"><a class="header-anchor" href="#关于会话session"><span>关于会话Session</span></a></h2><pre><code class="language-bash"><span class="token comment"># 切换会话session</span>
ctrl+b s
...
ctrl+b $
</code></pre><h2 id="关于窗口window" tabindex="-1"><a class="header-anchor" href="#关于窗口window"><span>关于窗口Window</span></a></h2><pre><code class="language-bash"><span class="token comment">## 在当前 会话 中 创建create 新窗口</span>
ctrl+b c
...
</code></pre><h2 id="关于面板pane" tabindex="-1"><a class="header-anchor" href="#关于面板pane"><span>关于面板Pane</span></a></h2><pre><code># 在当前窗口中创建 竖 分屏面板
ctrl+b %
# 在当前窗口中创建 横 分屏面板
ctrl+b “
