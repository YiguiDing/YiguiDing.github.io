import{_ as i,o as n,c as e,e as s}from"./app-5e015a01.js";const l="/assets/C__实现连连看小游戏及寻路算法演示-8765aa60.gif",d="/assets/2022-10-18-16-56-24-8fea70e3.png",a={},r=s('<h1 id="实现连连看小游戏及寻路算法演示" tabindex="-1"><a class="header-anchor" href="#实现连连看小游戏及寻路算法演示" aria-hidden="true">#</a> 实现连连看小游戏及寻路算法演示</h1><p><img src="'+l+'" alt=""></p><h1 id="下载" tabindex="-1"><a class="header-anchor" href="#下载" aria-hidden="true">#</a> <a href="./uploads/%E8%BF%9E%E8%BF%9E%E7%9C%8B/Linkup.exe">--&gt;下载&lt;--</a></h1><h2 id="映射彩虹色" tabindex="-1"><a class="header-anchor" href="#映射彩虹色" aria-hidden="true">#</a> 映射彩虹色</h2><p><strong>原理</strong><br><img src="'+d+`" alt=""></p><p><strong>代码</strong></p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>    int preocess_color(double rate)//[0.0 ~ 1.0]  -&gt; struct rgb[char red,char green,char blue]
    {
        int R=0;
        int G=0;
        int B=0;
