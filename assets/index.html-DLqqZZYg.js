...
</code></pre><h3 id="编程实现-利用正则表达式实现" tabindex="-1"><a class="header-anchor" href="#编程实现-利用正则表达式实现"><span>编程实现：利用正则表达式实现</span></a></h3><pre><code class="language-java"><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>lang<span class="token punctuation">.</span>reflect<span class="token punctuation">.</span></span><span class="token class-name">Array</span></span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> _01_购物单 <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="_02-纸牌三角形" tabindex="-1"><a class="header-anchor" href="#_02-纸牌三角形"><span>_02_纸牌三角形</span></a></h2><p><img src="`+t+`" alt=""></p><pre><code class="language-java"><span class="token keyword">public</span> <span class="token keyword">class</span> _02_纸牌三角形 <span class="token punctuation">{</span>
 <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="_03-承压计算" tabindex="-1"><a class="header-anchor" href="#_03-承压计算"><span>_03_承压计算</span></a></h2><pre><code>题目描述 :
...
</code></pre><pre><code>思路
7   // 7的重量均匀落在5和8上
5 8 
7 8 8
9 2 7 2
</code></pre><h2 id="_04-魔方状态" tabindex="-1"><a class="header-anchor" href="#_04-魔方状态"><span>_04_魔方状态</span></a></h2><p><img src="`+o+`" alt=""></p><h2 id="_05-取数位" tabindex="-1"><a class="header-anchor" href="#_05-取数位"><span>_05_取数位</span></a></h2><p>题目描述<br> 求1个整数的第k位数字有很多种方法。<br> 以下的方法就是一种。</p><pre><code class="language-java"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span>
<span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> ______填空______<span class="token punctuation">;</span> <span class="token comment">// 递归即可，答案： f(x/10,k)</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="_06-最大公共子串" tabindex="-1"><a class="header-anchor" href="#_06-最大公共子串"><span>_06_最大公共子串</span></a></h2><p>最大公共子串长度问题就是：<br> 求两个串的所有子串中能够匹配上的最大长度是多少。</p><p>比如：“abcdkkk” 和 “baabcdadabc”，<br> 可以找到的最长的公共子串是&quot;abcd&quot;,所以最大公共子串长度为4。</p><p>下面的程序是采用矩阵法进行求解的，这对串的规模不大的情况还是比较有效的解法。</p><pre><code class="language-java"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span>
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="_07-日期问题" tabindex="-1"><a class="header-anchor" href="#_07-日期问题"><span>_07_日期问题</span></a></h2><pre><code>题目描述
...
2004-02-03
2004-03-02
</code></pre><pre><code class="language-java"><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token class-name">HashSet</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token class-name">Scanner</span></span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> _07_日期问题 <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="_08-包子凑数" tabindex="-1"><a class="header-anchor" href="#_08-包子凑数"><span>_08_包子凑数</span></a></h2><pre><code>题目：
...
最大运行时间：1s
最大运行内存: 256M
</code></pre><h2 id="_09-分巧克力" tabindex="-1"><a class="header-anchor" href="#_09-分巧克力"><span>_09_分巧克力</span></a></h2><h2 id="_10-k倍区间" tabindex="-1"><a class="header-anchor" href="#_10-k倍区间"><span>_10_K倍区间</span></a></h2><pre><code>K倍区间
题目描述：
...
6
</code></pre><h3 id="使用前缀和的解法" tabindex="-1"><a class="header-anchor" href="#使用前缀和的解法"><span>使用前缀和的解法</span></a></h3><pre><code class="language-java"><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token class-name">Scanner</span></span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> _10_K倍区间 <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="使用线段树的解法" tabindex="-1"><a class="header-anchor" href="#使用线段树的解法"><span>使用线段树的解法</span></a></h3><pre><code class="language-java"><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token class-name">Scanner</span></span><span class="token punctuation">;</span>
