import{_ as s,o as n,c as e,e as a}from"./app-5e015a01.js";const i={},l=a(`<h1 id="ubuntu配置code-server过程记录" tabindex="-1"><a class="header-anchor" href="#ubuntu配置code-server过程记录" aria-hidden="true">#</a> ubuntu配置code-server过程记录</h1><p><strong>完整过程</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载</span>
