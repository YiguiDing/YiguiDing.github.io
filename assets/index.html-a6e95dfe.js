import{_ as n,o as s,c as a,e}from"./app-40b3468d.js";const t="/assets/image-db5d8fa8.png",i={},p=e(`<h1 id="使用workflows实现对vuepress的一键部署" tabindex="-1"><a class="header-anchor" href="#使用workflows实现对vuepress的一键部署" aria-hidden="true">#</a> 使用workflows实现对vuepress的一键部署</h1><p><strong>服务端配置记录</strong></p><p><strong>创建git用户</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建一个用户</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),l=[p];function c(o,u){return s(),a("div",null,l)}const d=n(i,[["render",c],["__file","index.html.vue"]]);export{d as default};
