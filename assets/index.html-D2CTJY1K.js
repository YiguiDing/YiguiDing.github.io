import{_ as n,c as e,e as a,o as i}from"./app-CHjqYunX.js";const l={};function p(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="alpine安装code-server过程记录" tabindex="-1"><a class="header-anchor" href="#alpine安装code-server过程记录"><span>alpine安装code-server过程记录</span></a></h2><h2 id="尝试1-在ish中尝试通过npm安装-配置失败" tabindex="-1"><a class="header-anchor" href="#尝试1-在ish中尝试通过npm安装-配置失败"><span>尝试1：在iSH中尝试通过npm安装（配置失败）</span></a></h2><p><strong>先要安装<code>npm</code>和<code>nodejs</code></strong><br> 但由于npm软件最新版使用了一些ish没有实现的指令 导致运行npm会提示非法指令 所以只能安装低版本</p><p><strong>1.修改 /etc/apk/repositories 将版本改为3.12版本</strong></p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 修改</span></span>
