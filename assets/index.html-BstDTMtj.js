...
</code></pre><p>for循环赋值指令耗时1个周期、自增耗时1个周期、比较耗时2个周期<br> 假设循环t次，耗时1000机器周期，则 1+3t=1000,则t=(1000-1)/3=333</p><p>所以可以设计这样一个延时函数</p><pre><code class="language-c"><span class="token keyword">void</span> <span class="token function">delay</span><span class="token punctuation">(</span><span class="token keyword">char</span> second<span class="token punctuation">)</span>
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="delay函数-写法2" tabindex="-1"><a class="header-anchor" href="#delay函数-写法2"><span>delay函数：写法2</span></a></h3><blockquote><p>（实际上char 8bit无法写入500，所以这么写还是有问题）</p></blockquote><p><strong>更高效的写法:</strong></p><pre><code class="language-c"><span class="token operator">:</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">-</span>源代码<span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">-</span><span class="token operator">:</span>
...
</code></pre><p>for循环赋值指令耗时1个周期、循环耗时2t个周期<br> 假设循环t次，耗时1000机器周期，则 1+2t=1000,则t=(1000-1)/2=499.5</p><p>所以可以设计这样一个delay函数</p><pre><code class="language-c"><span class="token keyword">void</span> <span class="token function">delay</span><span class="token punctuation">(</span><span class="token keyword">char</span> second<span class="token punctuation">)</span>
<span class="token punctuation">{</span>
    <span class="token keyword">for</span><span class="token punctuation">(</span><span class="token punctuation">;</span><span class="token operator">--</span>second<span class="token punctuation">;</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="delay函数-写法3" tabindex="-1"><a class="header-anchor" href="#delay函数-写法3"><span>delay函数：写法3</span></a></h3><blockquote><p>实际上内层循环应该用int，但是用int后的机器周期的计算就没有用char时的那么显而易见了</p></blockquote><pre><code class="language-c">line level    source
...
<span class="token number">000</span>D <span class="token number">22</span>                RET     
             <span class="token punctuation">;</span> FUNCTION <span class="token function">delay</span> <span class="token punctuation">(</span>END<span class="token punctuation">)</span>
</code></pre><p><strong>直接给出代码吧</strong></p><pre><code class="language-c"><span class="token comment">// 12MHz时实现毫秒级延迟的写法</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token keyword">for</span> <span class="token punctuation">(</span>i <span class="token operator">=</span> ms<span class="token punctuation">;</span> i <span class="token operator">&gt;</span> <span class="token number">0</span><span class="token punctuation">;</span> i<span class="token operator">--</span><span class="token punctuation">)</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span>j <span class="token operator">=</span> <span class="token number">123</span><span class="token punctuation">;</span> j <span class="token operator">&gt;</span> <span class="token number">0</span><span class="token punctuation">;</span> j<span class="token operator">--</span><span class="token punctuation">)</span>
            <span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="c51-ram分布" tabindex="-1"><a class="header-anchor" href="#c51-ram分布"><span>c51-RAM分布</span></a></h2><ul><li><code>0x00-0x1F</code> 0x20(32)个通用寄存器 <ul><li>分为0、1、2、3四组</li><li>每组有R0~R7八个寄存器</li><li>所以4x8=32个寄存器</li></ul></li><li><code>0x20-0x2F</code> 0x10(16)个支持位寻址的字节数据区</li><li><code>0x30-0x7F</code> 0x50(80)个字节的用户RAM区 <ul><li>同时也是栈区</li></ul></li></ul><p><img src="`+T+'" alt=""></p><h2 id="c51-基本数据类型" tabindex="-1"><a class="header-anchor" href="#c51-基本数据类型"><span>C51-基本数据类型</span></a></h2><p><img src="'+M+`" alt=""></p><h2 id="reg51-h头文件" tabindex="-1"><a class="header-anchor" href="#reg51-h头文件"><span>reg51.h头文件</span></a></h2><p>reg51.h里面主要是一些特殊功能寄存器的地址声明</p><pre><code class="language-c">sfr  P1 <span class="token operator">=</span> <span class="token number">0x90</span>   <span class="token comment">//这句话表示：P1口所对应的特殊功能寄存器P1在内存中的地址为0x80，</span>
...
</code></pre><h3 id="sfr关键字" tabindex="-1"><a class="header-anchor" href="#sfr关键字"><span>sfr关键字</span></a></h3><ul><li>特殊功能寄存器(special function register)</li><li>它并非标准C语言的关键字，而是Keil 为能直接访问80C51中的 SFR 而提供了一个新的关键词，</li><li>用法: <ul><li>sfr 特殊功能寄存器名=地址值</li><li>用户实际上也可以修改的，如P1=0x80，也可改为A1=0x80</li><li>但sfr 和地址值则不能更改，否者会编译出错。</li></ul></li><li>特殊功能寄存器布局 <ul><li>事实上只有第一列的地址可以位寻址</li><li><img src="`+P+`" alt=""></li></ul></li></ul><h3 id="sbit关键字" tabindex="-1"><a class="header-anchor" href="#sbit关键字"><span>sbit关键字</span></a></h3><ul><li>表示特殊功能寄存器位</li><li>是非标准C语言的关键字</li><li>在对寄存器的某一位(必须是可位寻址的特殊功能寄存器才能用)操作时使用</li><li>如： <ul><li>sbit LED = P1^0;</li><li>sbit EA = 0xAF;</li></ul></li><li>位定义用法有三种： <ul><li>第一种方法：sbit 位变量名＝ 寄存器位地址值</li><li>第二种方法：sbit 位变量名＝SFR 名称^寄存器位值(0-7)</li><li>第三种方法：sbit 位变量名＝SFR 地址值^寄存器位值</li></ul></li></ul><pre><code class="language-c"><span class="token comment">// sbit 特殊功能寄存器位</span>
...
</code></pre><h3 id="带注释的reg51-h" tabindex="-1"><a class="header-anchor" href="#带注释的reg51-h"><span>带注释的REG51.H</span></a></h3><pre><code class="language-c"><span class="token comment">/*--------------------------------------------------------------------------
...
</code></pre><h3 id="cy进位寄存器" tabindex="-1"><a class="header-anchor" href="#cy进位寄存器"><span>CY进位寄存器</span></a></h3><p><img src="`+F+`" alt=""></p><p><code>REG51.H</code></p><pre><code>/*--------------------------------------------------------------------------
REG51.H

sbit CY    = PSW^7; // 溢出位
</code></pre><h2 id="led流水灯实现" tabindex="-1"><a class="header-anchor" href="#led流水灯实现"><span>LED流水灯实现</span></a></h2><p><img src="`+I+`" alt=""></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;REG51.H&gt;</span></span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-c"><span class="token comment">// 12MHz时实现毫秒级延迟的写法</span>
<span class="token keyword">void</span> <span class="token function">delay</span><span class="token punctuation">(</span><span class="token keyword">unsigned</span> <span class="token keyword">int</span> ms<span class="token punctuation">)</span>
<span class="token punctuation">{</span>
    <span class="token keyword">unsigned</span> <span class="token keyword">int</span> i<span class="token punctuation">,</span> j<span class="token punctuation">;</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span>i <span class="token operator">=</span> ms<span class="token punctuation">;</span> i <span class="token operator">&gt;</span> <span class="token number">0</span><span class="token punctuation">;</span> i<span class="token operator">--</span><span class="token punctuation">)</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span>j <span class="token operator">=</span> <span class="token number">123</span><span class="token punctuation">;</span> j <span class="token operator">&gt;</span> <span class="token number">0</span><span class="token punctuation">;</span> j<span class="token operator">--</span><span class="token punctuation">)</span> <span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="_1位数数码管驱动实现" tabindex="-1"><a class="header-anchor" href="#_1位数数码管驱动实现"><span>1位数数码管驱动实现</span></a></h2><p><img src="`+N+`" alt=""></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;REG52.H&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">ifndef</span> <span class="token expression">_UTILS_</span></span>
...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
</code></pre><h2 id="多位数码管驱动实现" tabindex="-1"><a class="header-anchor" href="#多位数码管驱动实现"><span>多位数码管驱动实现</span></a></h2><p><img src="`+O+`" alt=""></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;REG52.H&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
...
<span class="token keyword">void</span> <span class="token function">delay</span><span class="token punctuation">(</span><span class="token keyword">unsigned</span> <span class="token keyword">int</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
</code></pre><h2 id="lcd1602-lcm1602-驱动编写" tabindex="-1"><a class="header-anchor" href="#lcd1602-lcm1602-驱动编写"><span>LCD1602(LCM1602)驱动编写</span></a></h2><p><img src="`+G+'" alt=""></p><p><img src="'+q+'" alt=""></p><p><img src="'+H+'" alt=""></p><p><img src="'+U+'" alt=""><br><img src="'+V+'" alt=""></p><p><img src="'+W+'" alt=""></p><p><img src="'+j+`" alt=""></p><p><code>1602.h</code></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">ifndef</span> <span class="token expression">__LCD_1602_H_</span></span>
...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
</code></pre><p><code>1602.c</code></p><pre><code class="language-c"><span class="token comment">// 低级接口</span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p><code>utils.h</code></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
...
<span class="token punctuation">}</span>
</code></pre><h2 id="lcd1602驱动调用测试" tabindex="-1"><a class="header-anchor" href="#lcd1602驱动调用测试"><span>LCD1602驱动调用测试</span></a></h2><p><img src="`+K+'" alt=""></p><p><img src="'+z+`" alt=""></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;REG51.H&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="轻触开关下降沿触发" tabindex="-1"><a class="header-anchor" href="#轻触开关下降沿触发"><span>轻触开关下降沿触发</span></a></h2><p><strong>写法</strong></p><pre><code class="language-c">sbit k1 <span class="token operator">=</span> P2 <span class="token operator">^</span> <span class="token number">3</span><span class="token punctuation">;</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token keyword">return</span> <span class="token number">0</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;REG51.H&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;lcd1602.h&quot;</span></span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p><img src="`+Y+'" alt=""></p><h2 id="矩阵按键驱动编写" tabindex="-1"><a class="header-anchor" href="#矩阵按键驱动编写"><span>矩阵按键驱动编写</span></a></h2><blockquote><p>（支持多个按键同时按下）</p></blockquote><p><img src="'+X+`" alt=""></p><p><code>MatrixBtns.h</code></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">ifndef</span> <span class="token expression">_MatrixBtns_H_</span></span>
...
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span>
</code></pre><p><code>MatrixBtns.c</code></p><pre><code class="language-c">
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="使用测试" tabindex="-1"><a class="header-anchor" href="#使用测试"><span>使用测试</span></a></h3><p><img src="`+Z+`" alt=""></p><pre><code class="language-c"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;REG51.H&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;utils.h&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;lcd1602.h&quot;</span></span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&quot;MatrixBtns.h&quot;</span></span>
...
</code></pre><h2 id="定时器-计数器电路工作原理" tabindex="-1"><a class="header-anchor" href="#定时器-计数器电路工作原理"><span><code>定时器/计数器</code>电路工作原理</span></a></h2><p><img src="`+J+'" alt=""></p><h2 id="中断系统工作原理" tabindex="-1"><a class="header-anchor" href="#中断系统工作原理"><span>中断系统工作原理</span></a></h2><p><img src="'+Q+'" alt=""></p>',94),pn=[nn,sn,an];function tn(on,en){return o(),t("div",null,pn)}const ln=p($,[["render",tn],["__file","index.html.vue"]]),un=JSON.parse('{"path":"/%E7%94%B5%E5%AD%90/51%E5%8D%95%E7%89%87%E6%9C%BA%E9%87%8D%E5%AD%A6%E7%AC%94%E8%AE%B0/","title":"51单片机重学笔记","lang":"zh-CN","frontmatter":{"title":"51单片机重学笔记","cover":"./cover/51单片机重学笔记.png","date":"2023-06-23T06:05:42.000Z","tag":["电路"],"category":"电子","star":true,"description":"51单片机重学笔记 目录 51单片机重学笔记 目录 基本概念 丝印含义 引脚功能 最小系统和复位电路 常用外围器件 六角自锁开关 轻触开关 二极管 三极管 信号放大电路 三极管三种工作状态 场效应管 数码管 多位数码管 灌电流驱动 时钟周期、机器周期、指令周期 指令表 delay函数 delay函数：写法1 delay函数：写法2 delay函数：写法...","head":[["meta",{"property":"og:url","content":"https://dingdingdang.online/%E7%94%B5%E5%AD%90/51%E5%8D%95%E7%89%87%E6%9C%BA%E9%87%8D%E5%AD%A6%E7%AC%94%E8%AE%B0/"}],["meta",{"property":"og:site_name","content":"YiguiDing的Blog小站"}],["meta",{"property":"og:title","content":"51单片机重学笔记"}],["meta",{"property":"og:description","content":"51单片机重学笔记 目录 51单片机重学笔记 目录 基本概念 丝印含义 引脚功能 最小系统和复位电路 常用外围器件 六角自锁开关 轻触开关 二极管 三极管 信号放大电路 三极管三种工作状态 场效应管 数码管 多位数码管 灌电流驱动 时钟周期、机器周期、指令周期 指令表 delay函数 delay函数：写法1 delay函数：写法2 delay函数：写法..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-11-28T11:27:55.000Z"}],["meta",{"property":"article:author","content":"丁毅桂"}],["meta",{"property":"article:tag","content":"电路"}],["meta",{"property":"article:published_time","content":"2023-06-23T06:05:42.000Z"}],["meta",{"property":"article:modified_time","content":"2023-11-28T11:27:55.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"51单片机重学笔记\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-06-23T06:05:42.000Z\\",\\"dateModified\\":\\"2023-11-28T11:27:55.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"丁毅桂\\",\\"email\\":\\"2449695354@qq.com\\"}]}"],["meta",{"name":"baidu-site-verification","content":"codeva-PwE9Ts6nMl"}]]},"headers":[{"level":2,"title":"目录","slug":"目录","link":"#目录","children":[]},{"level":2,"title":"基本概念","slug":"基本概念","link":"#基本概念","children":[{"level":3,"title":"丝印含义","slug":"丝印含义","link":"#丝印含义","children":[]},{"level":3,"title":"引脚功能","slug":"引脚功能","link":"#引脚功能","children":[]},{"level":3,"title":"最小系统和复位电路","slug":"最小系统和复位电路","link":"#最小系统和复位电路","children":[]}]},{"level":2,"title":"常用外围器件","slug":"常用外围器件","link":"#常用外围器件","children":[{"level":3,"title":"六角自锁开关","slug":"六角自锁开关","link":"#六角自锁开关","children":[]},{"level":3,"title":"轻触开关","slug":"轻触开关","link":"#轻触开关","children":[]},{"level":3,"title":"二极管","slug":"二极管","link":"#二极管","children":[]},{"level":3,"title":"三极管","slug":"三极管","link":"#三极管","children":[]}]},{"level":2,"title":"灌电流驱动","slug":"灌电流驱动","link":"#灌电流驱动","children":[]},{"level":2,"title":"时钟周期、机器周期、指令周期","slug":"时钟周期、机器周期、指令周期","link":"#时钟周期、机器周期、指令周期","children":[]},{"level":2,"title":"指令表","slug":"指令表","link":"#指令表","children":[]},{"level":2,"title":"delay函数","slug":"delay函数","link":"#delay函数","children":[{"level":3,"title":"delay函数：写法1","slug":"delay函数-写法1","link":"#delay函数-写法1","children":[]},{"level":3,"title":"delay函数：写法2","slug":"delay函数-写法2","link":"#delay函数-写法2","children":[]},{"level":3,"title":"delay函数：写法3","slug":"delay函数-写法3","link":"#delay函数-写法3","children":[]}]},{"level":2,"title":"c51-RAM分布","slug":"c51-ram分布","link":"#c51-ram分布","children":[]},{"level":2,"title":"C51-基本数据类型","slug":"c51-基本数据类型","link":"#c51-基本数据类型","children":[]},{"level":2,"title":"reg51.h头文件","slug":"reg51-h头文件","link":"#reg51-h头文件","children":[{"level":3,"title":"sfr关键字","slug":"sfr关键字","link":"#sfr关键字","children":[]},{"level":3,"title":"sbit关键字","slug":"sbit关键字","link":"#sbit关键字","children":[]},{"level":3,"title":"带注释的REG51.H","slug":"带注释的reg51-h","link":"#带注释的reg51-h","children":[]},{"level":3,"title":"CY进位寄存器","slug":"cy进位寄存器","link":"#cy进位寄存器","children":[]}]},{"level":2,"title":"LED流水灯实现","slug":"led流水灯实现","link":"#led流水灯实现","children":[]},{"level":2,"title":"1位数数码管驱动实现","slug":"_1位数数码管驱动实现","link":"#_1位数数码管驱动实现","children":[]},{"level":2,"title":"多位数码管驱动实现","slug":"多位数码管驱动实现","link":"#多位数码管驱动实现","children":[]},{"level":2,"title":"LCD1602(LCM1602)驱动编写","slug":"lcd1602-lcm1602-驱动编写","link":"#lcd1602-lcm1602-驱动编写","children":[]},{"level":2,"title":"LCD1602驱动调用测试","slug":"lcd1602驱动调用测试","link":"#lcd1602驱动调用测试","children":[]},{"level":2,"title":"轻触开关下降沿触发","slug":"轻触开关下降沿触发","link":"#轻触开关下降沿触发","children":[]},{"level":2,"title":"矩阵按键驱动编写","slug":"矩阵按键驱动编写","link":"#矩阵按键驱动编写","children":[{"level":3,"title":"使用测试","slug":"使用测试","link":"#使用测试","children":[]}]},{"level":2,"title":"定时器/计数器电路工作原理","slug":"定时器-计数器电路工作原理","link":"#定时器-计数器电路工作原理","children":[]},{"level":2,"title":"中断系统工作原理","slug":"中断系统工作原理","link":"#中断系统工作原理","children":[]}],"git":{"createdTime":1700226391000,"updatedTime":1701170875000,"contributors":[{"name":"YiguiDing","email":"2449695354@qq.com","commits":2}]},"readingTime":{"minutes":24.87,"words":7462},"filePathRelative":"电子/51单片机重学笔记/index.md","localizedDate":"2023年6月23日","excerpt":"","autoDesc":true}');export{ln as comp,un as data};
