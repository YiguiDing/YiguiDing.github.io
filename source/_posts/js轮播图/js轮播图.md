...
<script>
    (function(){
        ...
        bannerUl.addEventListener("mousedown",function(e){
            ...
            document.addEventListener("mousemove",bannerUlMoveWithMouse)
            document.addEventListener("mouseup",bannerUlMoveWithMouseToCorrectPos)
        ...
        bannerUl.addEventListener("touchstart",function(e){
            ...
            document.addEventListener("touchmove",bannerUlMoveWithFinger)
            document.addEventListener("touchend",bannerUlMoveWithFingerToCorrectPos)
