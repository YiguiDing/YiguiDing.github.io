...
## 说明
* 因为感觉原先学CSS的时候没有学透彻，一直想重新系统性的学一遍，查缺补漏。
* 最近几天有时间就开始学了，顺便记个笔记，加深印象、方便复习和查阅。
...
- [css3重学笔记](#css3重学笔记)
    ...
    - [css3的书写顺序](#css3的书写顺序)
        ...
        - [正确书写顺序使浏览器加载更快的原因(来源网路)](#正确书写顺序使浏览器加载更快的原因来源网路)
    - [html嵌套原则](#html嵌套原则)
...
* 伪元素的`CSS`样式必须要有`content`属性,属性值可以为空
