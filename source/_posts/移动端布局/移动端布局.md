...
![](/images/移动端布局/2022-06-19-00-53-45.png)

* 写html时应该参考**逻辑**分辨率


### 手机端物理分辨率和逻辑分辨率
![](/images/移动端布局/2022-06-19-01-46-41.png)
...
![](/images/移动端布局/2022-06-19-01-51-53.png)

* 使用`meta`标签设置**视口**，可以使**网页宽度**和设备的**逻辑宽度**一致
    ```html
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ```
    ![](/images/移动端布局/2022-06-19-01-56-49.png)
...
![](/images/移动端布局/2022-06-19-02-58-50.png)
...
### flex布局的构成
![](/images/移动端布局/2022-06-19-03-39-43.png)
...
* 属性名：`justify-content`
* 属性值：![](/images/移动端布局/2022-06-19-03-57-53.png)
...
![](/images/移动端布局/2022-06-19-04-31-31.png)
...
* 属性名：`flex-direction`
* 属性值：
    ![](/images/移动端布局/2022-06-20-06-54-01.png)
...
* 取值：
    * `no-wrap` 默认值
        * 弹性盒子会受到挤压，设定的宽度会失效
        * ![](/images/移动端布局/2022-06-20-08-10-02.png)
    * `wrap` 换行 
        * 弹性盒子的尺寸不会受到挤压，会在弹性容器容纳不下时换行
        * ![](/images/移动端布局/2022-06-20-08-09-01.png)
...
#### 问题
* 如何处理最后一行不能左对齐的问题？
![](/images/移动端布局/2022-06-20-08-58-31.png)
