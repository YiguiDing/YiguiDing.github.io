  ...
  atlas: [
    {
      name: "jump_effect",
      paths: [
        "/assets/jump_effect_1.png",
        "/assets/jump_effect_2.png",
        "/assets/jump_effect_3.png",
        "/assets/jump_effect_4.png",
        "/assets/jump_effect_5.png",
      ],
    },
    {
      name: "land_effect",
    ...
    },
    {
      name: "pea_break",
      paths: [
        "/assets/pea_break_1.png",
        "/assets/pea_break_2.png",
        "/assets/pea_break_3.png",
      ],
    },
    {
      name: "peashooter_attack_ex",
      paths: [
        "/assets/peashooter_attack_ex_1.png",
        "/assets/peashooter_attack_ex_2.png",
        "/assets/peashooter_attack_ex_3.png",
      ],
    },

    {
      name: "peashooter_die",
      paths: [
        "/assets/peashooter_die_1.png",
        "/assets/peashooter_die_2.png",
        "/assets/peashooter_die_3.png",
        "/assets/peashooter_die_4.png",
      ],
    },
    ...
    },
    {
      name: "peashooter_run",
      paths: [
        "/assets/peashooter_run_1.png",
        "/assets/peashooter_run_2.png",
        "/assets/peashooter_run_3.png",
        "/assets/peashooter_run_4.png",
        "/assets/peashooter_run_5.png",
      ],
    },
    {
      name: "run_effect",
      paths: [
        "/assets/run_effect_1.png",
        "/assets/run_effect_2.png",
        "/assets/run_effect_3.png",
        "/assets/run_effect_4.png",
      ],
    },
    {
      name: "sun",
    ...
    },
    {
      name: "sun_ex_explode",
      paths: [
        "/assets/sun_ex_explode_1.png",
        "/assets/sun_ex_explode_2.png",
        "/assets/sun_ex_explode_3.png",
        "/assets/sun_ex_explode_4.png",
        "/assets/sun_ex_explode_5.png",
      ],
    },
    {
      name: "sun_explode",
      paths: [
        "/assets/sun_explode_1.png",
        "/assets/sun_explode_2.png",
        "/assets/sun_explode_3.png",
        "/assets/sun_explode_4.png",
        "/assets/sun_explode_5.png",
      ],
    },
    {
      name: "sun_text",
      paths: [
        "/assets/sun_text_1.png",
        "/assets/sun_text_2.png",
        "/assets/sun_text_3.png",
        "/assets/sun_text_4.png",
        "/assets/sun_text_5.png",
        "/assets/sun_text_6.png",
      ],
    },
    {
    ...
    },
    {
      name: "sunflower_run",
      paths: [
        "/assets/sunflower_run_1.png",
        "/assets/sunflower_run_2.png",
        "/assets/sunflower_run_3.png",
        "/assets/sunflower_run_4.png",
        "/assets/sunflower_run_5.png",
      ],
    },
  ],
  audios: [
...
async function loadResources() {
  ...
  console.log("load atlas left done");

  for (let index = 0; index < resource_descriptions.atlas.length; index++) {
    const atlas = resource_descriptions.atlas[index];
    resource.atlas.set(
      atlas.name + "_right",
      await Atlas.loadFlipAtlas(atlas.paths)
    );
  }
  console.log("load atlas right done");
