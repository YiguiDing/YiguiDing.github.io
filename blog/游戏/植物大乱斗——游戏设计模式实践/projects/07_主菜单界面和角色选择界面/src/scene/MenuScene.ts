...
export class MenuScene implements Scene {
  backgroud = resources.images.get("menu_background")!;
  bgm_menu = resources.audios.get("bgm_menu")!;
  ui_confirm = resources.audios.get("ui_confirm")!;
  ...
  onDraw(ctx: CanvasRenderingContext2D): void {
    console.log("主菜单 绘制");
    ctx.drawImage(this.backgroud, 0, 0, ctx.canvas.width, ctx.canvas.height);
  }
