...
function generateChart (options) {
  const { width, height, id, monthLang, dayLang, weeks, title, echarts_Lib_URL } = Object.assign({ width: '600', height: '165', id: 'calendar', monthLang: 'en', dayLang: 'en', weeks: 40, title: 'Calendar' }, options)
  let commitData = '[]'
  ...
  return `
<div id="${id}_parent" style="width:100%;overflow-x:scroll;overflow-y:hidden;">
<div id="${id}" style="width: ${width}px;height:${height}px;"></div>
</div>
<script src="${echarts_Lib_URL}"></script>
<script type="text/javascript">
  (function(){
    ...
    function middleScroll(step,totalTime){
      let f = document.getElementById("${id}_parent")
...
function getCommitData (weeks = '40') {
  const _cmd = `git log --all --since="${weeks}.weeks" --date=iso --pretty=format:"%ad"`
